...
import { Descendant, Element as Element$1, BaseEditor, NodeEntry, BaseRange, Location, Editor, Text, Path, BaseText } from 'slate';
...
declare function useEditor({ initialMarkdown, authToken, height, minHeight, maxHeight, }: {
    initialMarkdown?: string;
    authToken?: string;
    height?: string | number;
    minHeight?: string | number;
...
declare function createWysimark(containerElement: HTMLElement, options: EditorOptions): Wysimark;

export { createWysimark };
