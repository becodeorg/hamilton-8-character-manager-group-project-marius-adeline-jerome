...
function createEditable(plugins2) {
  ...
  return function SinkEditable3(props) {
    let CurrentRenderEditable = (props2) => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _slatereact.Editable, { ...props2 });
    for (const fn of fns) {
    ...
    return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, CurrentRenderEditable, { ...props });
  };
}
...
function SinkEditable(originalProps) {
  ...
  return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, NextEditable, { ...originalProps, ...nextProps });
}
...
function isElementType(node2, type) {
  if (Array.isArray(type)) {
    return _slate.Element.isElement(node2) && type.includes(node2.type);
  }
  if (typeof type === "string") {
    return _slate.Element.isElement(node2) && node2.type === type;
  }
  throw new Error(
...
function Menu({
  ...
  return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, _jsxruntime.Fragment, { children: [
    ...
    /* @__PURE__ */ _jsxruntime.jsx.call(void 0, $Menu, { ref, style, children: items2.map((item, index2) => {
      if (item === "divider") {
        return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, $MenuDivider, {}, index2);
      } else {
        return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, MenuItem, { editor, item, close }, index2);
      }
    }) })
  ] });
}
      ...
      "a",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "div", { className: "--url", children: [
            ...
            /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "div", { className: "--pathname", children: url.pathname })
          ] })
        ]
      }
    ),
...
function CodeBlock({
  ...
  const onClick = _react.useCallback.call(void 0, () => {
    ...
    dropdown.open(() => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, Menu, { dest, items: items2, close: dropdown.close }));
  }, [element2]);
  return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, $CodeBlock, { className: selected ? "--selected" : "", ...attributes, children: [
    ...
    /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "code", { children })
  ] });
}
...
function TaskListItem({
  ...
  return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, $TaskListItem, { ...attributes, style, children: [
    /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "div", { className: "--list-item-icon", contentEditable: false, children: element2.checked ? /* @__PURE__ */ _jsxruntime.jsx.call(void 0, CheckedIcon, {}) : /* @__PURE__ */ _jsxruntime.jsx.call(void 0, UncheckedIcon, {}) }),
    children
  ] });
}
...
function ColumnMenu({ cellElement }) {
  ...
  const onClick = _react.useCallback.call(void 0, () => {
    ...
    menu.open(() => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, Menu, { dest, items: items2, close: menu.close }));
  }, []);
  return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, 
    $ColumnMenu,
    {
...
var More = () => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, TablerIcon, { width: "0.5em", viewBox: "0 0 12 24", children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "path", { d: "m2 12 4 4 4-4", opacity: 0.375 }) });
...
var Attachment = () => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, TablerIcon, { children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "path", { d: "m15 7-6.5 6.5a1.5 1.5 0 0 0 3 3L18 10a3 3 0 0 0-6-6l-6.5 6.5a4.5 4.5 0 0 0 9 9L21 13" }) });
...
function ToolbarButton({
  ...
  const openMenu = _react.useCallback.call(void 0, () => {
    ...
    if (items2) {
      ...
      menu.open(() => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, Component, { dest, close: menu.close }));
    }
  }, [item]);
  const onClick = _react.useCallback.call(void 0, () => {
    if (item.action) {
  ...
  return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, 
    $ToolbarButton,
    {
      ...
      onMouseLeave: tooltip.onMouseLeave,
      onClick,
      className: _clsx.clsx.call(void 0, { "--active": active }),
      children: [
...
function ToolbarItem({ item }) {
  const editor = _slatereact.useSlateStatic.call(void 0, );
  if (item === "divider") {
    return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, $ToolbarDivider, {});
  } else {
...
function Toolbar() {
  return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, $Toolbar, { children: items.map((item, index2) => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, ToolbarItem, { item }, index2)) });
}
...
function Editable2({ editor, onChange, ...extraProps }) {
  return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 
    _slatereact.Slate,
    {
      ...
      onChange,
      children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, SinkEditable2, { renderLeaf, ...extraProps })
    }
  );
}
...
function StandaloneEditor({
  ...
  _react.useImperativeHandle.call(void 0, editorRef, () => editor, [editor]);
  return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, Editable2, { editor, onChange, placeholder });
}
function createWysimark(containerElement, options) {
  const editorRef = _react.createRef.call(void 0, );
  const root = _client.createRoot.call(void 0, containerElement);
  root.render(/* @__PURE__ */ _jsxruntime.jsx.call(void 0, StandaloneEditor, { editorRef, options }));
  return {
    unmount() {
      try {
        root.unmount();
    ...
    getMarkdown() {
      const markdown = _optionalChain([editorRef, 'access', _43 => _43.current, 'optionalAccess', _44 => _44.getMarkdown, 'call', _45 => _45()]);
      return typeof markdown === "string" ? markdown : options.initialMarkdown || "";
    },
    setMarkdown(markdown) {
      _optionalChain([editorRef, 'access', _46 => _46.current, 'optionalAccess', _47 => _47.resetMarkdown, 'call', _48 => _48(markdown)]);
    }
  };
}
