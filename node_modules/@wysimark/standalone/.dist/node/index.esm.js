...
function TaskListItem({
  ...
  return /* @__PURE__ */ jsxs20($TaskListItem, { ...attributes, style, children: [
    /* @__PURE__ */ jsx43("div", { className: "--list-item-icon", contentEditable: false, children: element.checked ? /* @__PURE__ */ jsx43(CheckedIcon, {}) : /* @__PURE__ */ jsx43(UncheckedIcon, {}) }),
    children
  ] });
}
...
function insertRootElement2(editor, element, { at = editor.selection } = {}) {
  ...
  if (entry == null) {
    ...
    Editor44.withoutNormalizing(editor, () => {
      Transforms31.insertNodes(editor, element, { at });
      if (selection) {
    ...
    Editor44.withoutNormalizing(editor, () => {
      Transforms31.insertNodes(editor, element, { at: nextPath });
...
function normalizeTableCell(editor, entry) {
  ...
  Editor52.withoutNormalizing(editor, () => {
    ...
    for (let i = node2.children.length; i >= 0; i--) {
      Transforms38.mergeNodes(editor, { at: [...path2, i] });
    }
...
`;
    ...
    case "task-list-item": {
      const indent3 = " ".repeat(element.depth * LIST_INDENT_SIZE);
      return `${indent3}- [${element.checked ? "x" : " "}] ${serializeLine(
        element.children
      )}
